    ...
    <div class="row">
      <div class="col-md-4">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li role="presentation"><a href="/info/search">搜索</a></li>
        </ul>
      </div>
      <div class="col-md-8">      
        <form action="/info/do_add_avatar/${info.id}" enctype="multipart/form-data" method="post">
            <div class="form-group">
                <label for="avatar">证件照</label>
